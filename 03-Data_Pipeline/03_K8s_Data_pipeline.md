...
#### 📋 Exercice — Déployer MinIO sur Kubernetes
...
#### 📋 Exercice — Créer le script d'ingestion
...
#### 📋 Exercice — Déployer l'ingester en CronJob
...
#### 📋 Exercice — Exécuter dbt en Job Kubernetes
  ...
  template:
    spec:
      ...
      - name: transformer
        ...
        imagePullPolicy: IfNotPresent
        env:
        - name: MINIO_ENDPOINT_HOST    # Uniquement host:port, sans http:// — format attendu par DuckDB httpfs
...
#### 📋 Exercice — Créer l'application FastAPI
...
#### 📋 Exercice — Déployer l'API en Deployment + Service
...
#### 📋 Challenge — Déployer la stack Prometheus + Grafana
